...
export const guidanceBlocks: GuidanceBlock[] = [
  ...
  },
  {
    ...
    bodySourceIds: {
      ...
      4: ["phe-case-study", "who-national-genomic-surveillance-strategy-2023", "aphl-ngs-implementation-2016"],
    },
    technicalDetail: [
    ...
    gaps: ["A reusable pipeline release, rollback, emergency-fix and revalidation runbook still needs detailed laboratory-quality source extraction."],
  },
  {
  ...
  },
  {
    ...
    bodySourceIds: {
      ...
      4: ["phe-case-study", "clinical-microbiology-implementation-2026"],
    },
    audiences: ["director", "policy", "lab-lead", "bioinformatician", "data-manager", "all"],
    implementationStages: ["pilot", "routine-service", "national-scale", "upgrading"],
    organisms: ["general", "enteric-bacteria", "tb", "respiratory-viruses", "amr", "nosocomial", "other"],
